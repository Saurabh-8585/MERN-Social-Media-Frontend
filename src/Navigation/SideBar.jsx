...
import { FiHome, FiHash, FiBell, FiMail, FiBookmark, FiUser, FiSettings } from 'react-icons/fi';
...
const Sidebar = () => {
    ...
    return (
        <>
            <Navbar />
            <nav className="fixed z-40 bottom-0 left-0 lg:fixed lg:top-10 lg:bottom-0 lg:w-1/4 lg:h-full lg:flex lg:flex-col bg-white dark:bg-gray-800 border-gray-300 lg:dark:border-white lg:border-r-2 border-t-2 w-full ">
